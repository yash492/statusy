...
func (d datadogUS3) ScrapScheduledMaintenance() ([]scheduledmaintenance.ScheduledMaintenance, error) {
	var req atlassian.ScheduledMaintenanceReq
	_, err := d.RestyClient.
		R().
		SetResult(&req).
		Get(scheduledMaintenanceUrlUS3)
	if err != nil {
		return nil, err
	}
...
func registerUS3(client *resty.Client) {
